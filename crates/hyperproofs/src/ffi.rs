...
extern "C" {
    pub fn initVc(round: GoUint64) -> GoInt64;
}
extern "C" {
    pub fn pushAddressDeltaVc(address: GoUint64, deltaString: GoString, shard: GoUint64)
        -> GoInt64;
}
extern "C" {
    pub fn pushAddressCommitVc(address: GoUint64, shard: GoUint64) -> GoInt64;
}
extern "C" {
    pub fn pushAddressBalanceVerifyVc(
        address: GoUint64,
        balanceString: GoString,
        shard: GoUint64,
    ) -> GoInt64;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct aggVc_return {
    pub r0: *mut ::std::os::raw::c_char,
    pub r1: GoUint8,
}
#[test]
fn bindgen_test_layout_aggVc_return() {
    assert_eq!(
        ::std::mem::size_of::<aggVc_return>(),
        16usize,
        concat!("Size of: ", stringify!(aggVc_return))
    );
    assert_eq!(
        ::std::mem::align_of::<aggVc_return>(),
        8usize,
        concat!("Alignment of ", stringify!(aggVc_return))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<aggVc_return>())).r0 as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(aggVc_return),
            "::",
            stringify!(r0)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<aggVc_return>())).r1 as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(aggVc_return),
...
extern "C" {
    pub fn aggVc(nativeShard: GoUint64) -> aggVc_return;
}
extern "C" {
    pub fn commitVc(nativeShard: GoUint64, round: GoUint64) -> GoInt64;
}
extern "C" {
    pub fn verifyProofVc(proofString: GoString, shard: GoUint64, round: GoUint64) -> GoUint8;
}
extern "C" {
    pub fn demoProof() -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn demoVerify(proofString: GoString) -> GoUint8;
}
